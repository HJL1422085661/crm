...
public interface PayBackRecordTempService {
    ...
    Page<PayBackRecordTemp> findPayBackRecordTempByCheckedStatus(Integer status, Pageable pageable);

    Page<PayBackRecordTemp> findPayBackRecordTempByCheckedStatusIsNot(Integer status, Pageable pageable);
